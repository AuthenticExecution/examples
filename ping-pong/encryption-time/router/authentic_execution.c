...
void handle_output(void *session, uint8_t *num, uint16_t output_id, unsigned char *conn_id,
	...
	for(int i = 0; i < *num; i++) {
		...
		if(connection->encryption == AES) {
			...
			TEE_GetREETime(&t);
			printf("\n");
			printf("time before AES encryption in handle_output(router): %u.%03u\n", 
			...
			if (!res) {
				printf("\n");
				TEE_GetREETime(&t);
				printf("time after AES encryption in handle_output(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
				printf("\n");
			...
			printf("\n");
			TEE_GetREETime(&t);
			printf("time before SPONGENT encryption in handle_output(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
			...
			printf("\n");
			TEE_GetREETime(&t);
			printf("time after SPONGENT encryption in handle_output(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
			printf("\n");
...
TEE_Result handle_input(void *session, uint32_t param_types, TEE_Param params[4]){
	...
	if(connection->encryption == AES){
		...
		printf("\n");
		TEE_GetREETime(&t);
		printf("time before AES decryption in handle_input(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
		...
		if (!res) {
			printf("\n");
			TEE_GetREETime(&t);
			printf("time after AES decryption in handle_input(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
		...
		printf("\n");
		TEE_GetREETime(&t);
		printf("time before SPONGENT decryption in handle_input(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
		...
		printf("\n");
		TEE_GetREETime(&t);
		printf("time after SPONGENT decryption in handle_input(router): %u.%03u\n", 
							(unsigned int)t.seconds, (unsigned int)t.millis);
